...
var gainOrLossChart = dc.pieChart('#gain-loss-chart', 'demo');
var fluctuationChart = dc.barChart('#fluctuation-chart', 'demo');
var quarterChart = dc.pieChart('#quarter-chart', 'demo');
var dayOfWeekChart = dc.rowChart('#day-of-week-chart', 'demo');
var moveChart = dc.lineChart('#monthly-move-chart', 'demo');
var volumeChart = dc.barChart('#monthly-volume-chart', 'demo');
var yearlyBubbleChart = dc.bubbleChart('#yearly-bubble-chart', 'demo');
